...
class PuerresMap {
    ...
    savePOIsToStorage() {
        try {
            ...
            const allPOIs = this.markers.map(marker => {
                const coords = marker.getLatLng();
                return {
                    ...
                    icon: marker.poiData.icon,
                    color: marker.poiData.color,
            ...
            console.log('TODOS los POIs guardados en localStorage:', allPOIs);
    ...
    loadSavedPOIs() {
        try {
            ...
            console.log('Datos en localStorage:', savedPOIs);
